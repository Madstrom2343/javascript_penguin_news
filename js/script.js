...
function displayFeaturedStudentPanel() {
    ...
    const student = featuredStudents[randomStudent]
    ...
    // featuredStudents.forEach(function (element) {
    const img = document.createElement('img')
    img.setAttribute('src', student[2])
    img.setAttribute('class', "studentpic rounded mx-auto d-block")
    featuredStudent.appendChild(img)

    const h4 = document.createElement('h4')
    h4.innerText = student[0]
    h4.setAttribute('class', "text-center")
    featuredStudent.appendChild(h4)

    const p = document.createElement('p')
    p.innerText = student[1]
    featuredStudent.appendChild(p)
